package admin.skrzypekapp.config;

import admin.skrzypekapp.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    @Value("${app.cors.allowed-origins:http://localhost:4200}") // Domyślnie localhost jeśli brak zmiennej
        ...
        http
                ...
                .exceptionHandling(exception -> exception
                        ...
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            ...
                            response.setContentType("application/json");
                            response.getWriter().write("{\"error\":\"Forbidden\",\"message\":\"Brak uprawnień\"}");
                        })
                );
